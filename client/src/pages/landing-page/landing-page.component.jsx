  ...
  <div style={{ justifyContent: "center", alignItems: "center" }}>
    <div className="backgroundImage" style={{ width: "100vw", height: "100vh" }}>
      <div className="container">
        <span className="companyName">Nature’s <span className="frontier">Frontier</span> Landscaping & Property Management LLC</span>
        ...
        <div><Button className="landingButton" onClick={() => window.location.href = "http://nflandscaping.com/home"}>Join the party</Button></div>
      </div>
    </div>
  </div>
